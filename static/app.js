...
(function() {
	...
	function _updateColours() {
		...
		// document.getElementById('storeCount2').innerHTML = (nStores - index) ;
	...
	function _updateColours2() {
		document.getElementById('slider').value = document.getElementById('slider2').value;
		_updateColours();
	}
	function _updateColours1() {
		document.getElementById('slider2').value = document.getElementById('slider').value;
		_updateColours();
	}


	var updateColours1 = _.throttle(_updateColours1, 64);
	var updateColours2 = _.throttle(_updateColours2, 64);
	...
	var e = document.getElementById('slider');
	e.addEventListener('input', updateColours1);

	var e = document.getElementById('slider2');
	e.addEventListener('input', updateColours2);
